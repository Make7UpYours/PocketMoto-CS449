...
/** Loads & displays the Suit texture.
...
public class PMSuit {
	...
	/** Load up necessary attributes for PMSuit. */
	public PMSuit() {
		//Populate buffers.
		...
		suitColor = PMGameEngine.curPlayerSuit;
	}
	/** Draw Biker image. */
	public void draw(GL10 gl, int[] spriteSheet) {
		gl.glBindTexture(GL10.GL_TEXTURE_2D, spriteSheet[PMGameEngine.SUIT_SPRITE_INDEX]);
