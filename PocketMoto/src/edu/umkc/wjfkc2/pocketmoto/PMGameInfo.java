...
/** Loads & displays the Game Info textures.
...
public class PMGameInfo {
	 ...
	 * in order to show the correct display.
	 */
	...
	/** Load up necessary attributes for PMGameInfo. */
	public PMGameInfo() {
		//Populate buffers.
	...
	/** Draw Game info image. */
	public void draw(GL10 gl, int[] spriteSheet) {
		gl.glBindTexture(GL10.GL_TEXTURE_2D, spriteSheet[PMGameEngine.GAME_INFO_INDEX]);
